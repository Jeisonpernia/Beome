...
class FlatMates(http.Controller):
    ...
    def update_about_rooms_data(self, **kwargs):
        ...
        data_dict = {}
        if kwargs.get('current_property_id'):
            property_id = request.env['house.mates'].browse(int(kwargs.get('current_property_id')))
