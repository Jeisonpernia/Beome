...
//                        console.log ("Divvvvvvvvvvvv", div)
                        for (index=0 ; index<data['result'].length; index++)
                        {
                            ...
                            if (data['result'][index]['is_listing'] == true){
                                console.log('******************************* ',data['result'][index]['is_listing'])
                                var weekly_rent = data['result'][index]['weekly_rent']
                            ...
                            else if(data['result'][index]['is_finding'] == true){
                                console.log('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ :',data['result'][index]['is_finding'])
                                var weekly_budget = data['result'][index]['weekly_budget']
