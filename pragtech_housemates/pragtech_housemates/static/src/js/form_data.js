...
$(document).ready(function() {
        ...
        if (record_array[0])
        {
            ...
            record_array[0]['is_finding'] = true
            record_array[0]['find_property_looking_for'] = find_property_looking_for
            record_array[0]['find_teamups_status'] = find_teamups_status

            record_array.push(temp_dict)
            localStorage.setItem('find_place_record', JSON.stringify(record_array));
            //console.log('//////////////////////////////// ',temp_dict)
            console.log('iffffffffffff ::' ,localStorage.getItem('find_place_record'))
            ...
            localStorage.setItem('find_place_record', JSON.stringify(record_array));
            //console.log('//////////////////////////////// ',temp_dict)
            console.log('else ::' ,localStorage.getItem('find_place_record'))
...
//            console.log('final data=============',find_place_data)
...
//                  event.preventDefault()
                ...
                if (accommodation_type){
                        oldArray[0]['accommodation_type'] = accommodation_type
                }

                if (property_type){
                    oldArray[0]['property_type'] = property_type
                }

                if (accommodation_type != 'sharehouse'){
                    oldArray[0]['property_type'] = null
                }
...

            {
                ...
                console.log("  testihhhhhhhhhhhhhhhhhh",oldArray)
//                event.preventDefault()
                localStorage.setItem('list_place_array', JSON.stringify(oldArray));
            }
...
//                    console.log ("fffffffffffffffffffff",one_room_data)
...
//                        one_room_data.push({'bathroom_types' : $(this).val()})
                    count = count+1
//                    console.log ("fffffffffffffffffffff",one_room_data)
                    console.log ("fffffffffffffffffffff count ",count)
                }
            });
